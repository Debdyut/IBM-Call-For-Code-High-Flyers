 ...
 */
function create(personName, dob, emailId, phone, location, gender, isLabTestDone, haveRecentSymptoms, isFollowUpTestDone, lastDateOfSymptom, bloodGroup, userID) {
    return new Promise((resolve, reject) => {
        let itemId = uuidv4();
        ...
        let item = {
            ...
            gender: gender,
            dob: dob,
            isLabTestDone: isLabTestDone,
            haveRecentSymptoms: haveRecentSymptoms,
            isFollowUpTestDone: isFollowUpTestDone,
            haveRecentSymptoms: haveRecentSymptoms,
            lastDateOfSymptom: lastDateOfSymptom,
